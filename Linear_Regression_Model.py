...
# Load the dataset
dataset = pd.read_csv(r'C:\Users\User\Naresh It course\Salary Prediction App\Salary_Data.csv')
...
train_mse = root_mean_squared_error(y_train, regressor.predict(X_train))
...
filename = r'C:\Users\User\Naresh It course\Salary Prediction App\linear_regression_model.pkl'
